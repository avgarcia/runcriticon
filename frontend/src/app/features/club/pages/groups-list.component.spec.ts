...
describe('GroupsListComponent', () => {
  ...
  it('un grupo sin filtro lo dice en vez de dejar el hueco en blanco', async () => {
    groups.set([
      { id: 'g1', nombre: 'A mano', valores: [], totalAlumnos: 2, tieneEntrenador: false },
    ]);
    await crear();
  ...
  it('avisa del grupo en el que no cae nadie', async () => {
    groups.set([
      { id: 'g1', nombre: 'Vacío', valores: ['medio'], totalAlumnos: 0, tieneEntrenador: false },
    ]);
    await crear();
