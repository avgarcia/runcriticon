...
@Component({
  ...
  template: `
    ...
    <div role="listbox" [attr.aria-label]="label() || null" [class]="_computedListboxClasses()">
      <ng-content />
    </div>
...
export class HlmSelectContent {
  ...
  /**
   * Nombre accesible de la lista de opciones. Añadido sobre el helm original: su `role="listbox"` no
   * llevaba ninguno, y una lista sin nombre es una infracción de WCAG que el analizador marca en
   * cuanto la pantalla se somete a él.
   */
