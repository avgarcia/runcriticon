...
**Presupuesto de bundle**: el inicial va justo (`angular.json` avisa a 350 kB y falla a 550 kB; hoy ronda los 545 kB, y el grueso del margen consumido es `styles.css`, que crece con cada helm de spartan que se copia por las variantes Tailwind que arrastra). Antes de traer un helm nuevo, comprueba el tamaño. Jest y Playwright configurados. Las maquetas hi-fi en `../docs/diseno/` siguen siendo la referencia visual al construir nuevas pantallas.
