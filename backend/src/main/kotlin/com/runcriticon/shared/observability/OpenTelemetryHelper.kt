...
/**
 * Lee el contexto de traza distribuida (W3C Trace Context) del span OpenTelemetry en curso para propagarlo en los
 * integration events. El bridge `micrometer-tracing-bridge-otel` expone la API de OpenTelemetry; si no hay traza activa
