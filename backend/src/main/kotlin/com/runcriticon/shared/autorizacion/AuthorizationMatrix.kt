...
object AuthorizationMatrix {
    private val rules: Set<Triple<Role, Resource, Action>> =
        setOf(
            ...
            // admin no aparece aquí a propósito (el plan semanal en borrador no lo pide; si emerge la necesidad, se
            // añade con esa
            ...
            // Componer las sesiones de un plan (el editor de sesión de entrenamiento: alta, edición y borrado) es la
            // misma operación de quien
