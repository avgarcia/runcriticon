 ...
 * si una cuenta existe. El rate-limiting de envíos (ADR-0003 D12) se aborda en LAL-35.
 */
@ApplicationService
class RequestMagicLink(
    ...
    private fun issueAndSend(user: User) {
        ...
        val magicLink = MagicLink.issue(user.id, user.clubId, tokenHasher.hash(rawToken), now)
