...
/**
 * Listado de los entrenadores del club. Solo el ADMIN puede ejecutarlo). Es la base de la pantalla de gestión desde la
 * que el admin revoca sesiones o desactiva cuentas. Filtra por el club del principal: nunca lista entrenadores de
 * otro club.
 */
@ApplicationService
