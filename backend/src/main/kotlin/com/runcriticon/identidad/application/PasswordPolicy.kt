 ...
 * disparador de reapertura en ADR-0015. Reutilizable por la activación y el reseteo de contraseña por magic link.
 * Los `reason` son estables para que la capa REST/UI los traduzca; el frontend valida en
