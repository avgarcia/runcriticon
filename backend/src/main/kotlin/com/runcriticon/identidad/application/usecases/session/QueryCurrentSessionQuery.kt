...
/**
 * Devuelve el [Principal] de la sesión en curso (para `GET /api/sesion/actual`). Requiere sesión activa, que garantiza
 * la SecurityFilterChain; aquí solo se lee el principal del contexto: no hay regla de la
