 ...
 * `templates/email/password-reset.html`. Thymeleaf escapa por defecto los valores (`th:text`), evitando inyección de
 * HTML con el nombre del destinatario. Espejo de [MagicLinkEmailRenderer].
 */
@Component
