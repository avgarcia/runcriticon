...
/**
 * Adaptador del puerto [PasswordHistory] sobre Spring Data. Acotado por `userId`, así que no necesita el filtro de club
 * del principal: se usa en flujos sin sesión (activación, reseteo).
 */
@Repository
