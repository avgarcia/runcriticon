...
/**
 * Implementación Micrometer del puerto [BusinessMetrics]. Expone `identidad.accounts.activated`,tags `module` y `role`
 * (`ALUMNO`/`ENTRENADOR`; cardinalidad baja, sin `user_id`).
 *
 * Primer contador del catálogo instrumentado.
 */
@Component
