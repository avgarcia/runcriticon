...
/**
 * Adaptador del puerto [TokenGenerator]: 32 bytes (256 bits) de [SecureRandom] codificados en Base64 URL-safe sin
 * padding. El texto claro solo viaja al email; nunca se persiste.
 */
@Component
