...
import com.runcriticon.identidad.infrastructure.email.config.EmailConfig
import com.runcriticon.identidad.infrastructure.email.templates.InvitationEmailRenderer
import com.runcriticon.identidad.infrastructure.email.templates.MagicLinkEmailRenderer
import com.runcriticon.identidad.infrastructure.email.templates.PasswordResetEmailRenderer
import com.runcriticon.identidad.infrastructure.observability.IdentidadEmailMetrics
import org.springframework.context.annotation.Profile
import org.springframework.stereotype.Component
import org.springframework.web.client.RestClient

/**
 * Adaptador de email sobre la API HTTP de Postmark, activo en todos los perfiles salvo `local`. Envía el email vía
 * `RestClient` autenticando con el server token; registra el resultado en [IdentidadEmailMetrics] y propaga la
 * excepción para que el outbox reintente.
 */
@Component
@Profile("!local")
