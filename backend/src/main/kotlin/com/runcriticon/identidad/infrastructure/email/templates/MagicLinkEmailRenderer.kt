package com.runcriticon.identidad.infrastructure.email.templates
...
/**
 * Renderiza el cuerpo HTML del email de magic link a partir de la plantilla externa `templates/email/magic-link.html`.
 * Thymeleaf escapa por defecto los valores (`th:text`), evitando inyección de HTML con el nombre del destinatario.
 */
@Component
