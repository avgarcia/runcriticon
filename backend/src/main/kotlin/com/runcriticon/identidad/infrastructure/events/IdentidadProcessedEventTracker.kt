...
/**
 * Implementación de [ProcessedEventTracker] contra `identidad.evento_procesado`. Calco literal de
 * `PlanificacionProcessedEventTracker`: la tabla es de cada módulo, así que cada módulo que consuma eventos
 ...
 */
@Repository
@Qualifier(IdentidadProcessedEventTracker.QUALIFIER)
class IdentidadProcessedEventTracker(
    ...
    companion object {
        const val QUALIFIER = "identidadProcessedEventTracker"
    }
}

private val MARK_SQL =
    """
    INSERT INTO identidad.evento_procesado (listener, event_id)
    VALUES (?, ?)
