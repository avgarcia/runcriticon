...
/**
 * Mapeo JPA del asiento de auditoría de identidad. Categoría RGPD AUDITORIA_IDENTIDAD. La columna `metadata` (JSONB)
 * lleva contexto opcional del evento (p. ej. `email_hash` e `ip` en los eventos de rate-limiting).
 */
@Entity
