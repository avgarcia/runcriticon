...
/**
 * Spring Data JPA del asiento de auditoría. No se anota con @Repository (Spring Data lo registra solo); la malla de
 * autorización se aplica en el adaptador [AuditTrailImpl].
 */
