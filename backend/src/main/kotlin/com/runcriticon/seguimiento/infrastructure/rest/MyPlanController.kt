...
/**
 * La propia semana resuelta del alumno (LAL-29) y su reporte de sesión (LAL-30). `alumnoId` nunca es un
 * parámetro: sale siempre de [PrincipalProvider.current] — mismo criterio de `/me/permissions`, no el de los
 * controllers de `club_taxonomia`/`planificacion`, que sí reciben ids ajenos porque los opera el entrenador o
 * el admin.
 */
@RestController
