 ...
 * a las asignaciones de tags, que no son parte de la proyección sino clasificación del club. Quien borra no necesita
 * saber escribir, y quien escribe no necesita saber borrar.
 */
interface PersonErasure {
    /**
     * Borra la proyección de la persona y sus asignaciones de tags, y deja la **lápida** que impide que un evento de
     * alta rezagado vuelva a materializarla.
     *
