 ...
 * contiene a quien se incluya manualmente (D4) — caso borde explícito del criterio de aceptación del dominio Grupo
 * y la resolución de membresía sobre tags.
 *
 * **Fuera de esta raíz** (por diseño, no por olvido):
 * - Los overrides manuales (`grupo_alumno_override`, D4) — su caso de uso de escritura es el ajuste manual de
 * pertenencia a un grupo; este agregado no
