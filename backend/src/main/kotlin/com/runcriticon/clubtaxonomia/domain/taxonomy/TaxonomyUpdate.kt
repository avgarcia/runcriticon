 ...
 *
 * Se devuelven ambas porque el caso de uso necesita persistir la fila afectada y responder al cliente con su id
 * (p. ej. `201 Created` + `Location`) sin tener que deducir qué cambió comparando contra la versión anterior. Es el
