...
/**
 * Apéndice tipado y opcional de un `TagValue`.
 *
 * El dominio **no** conoce JSONB: la metadata se modela como esta `sealed class`, con una variante por tipo que
 * necesita cada eje. La serialización a/desde JSONB vive en el mapeador de `infrastructure`; si un JSON corrupto no
 * deserializa, el mapeador degrada a [Empty] y loguea — nunca propaga el fallo al dominio.
 *
