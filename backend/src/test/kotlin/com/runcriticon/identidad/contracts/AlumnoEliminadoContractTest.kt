...
/** Test de contrato: el [AlumnoEliminado] serializado cumple su JSON Schema v1. */
@Tag("contract")
class AlumnoEliminadoContractTest {
    private val mapper =
        JsonMapper
            .builder()
    ...
    private val schema =
        JsonSchemaFactory
            ...
            .getSchema(Path.of("../schemas/identidad/alumno-eliminado-v1.json").toUri())

    @Test
    fun `AlumnoEliminado serializado cumple el JSON Schema v1`() {
