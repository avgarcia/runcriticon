...
/**
 * Regresión del fallo en que `MergeSuggestionListener` hacía upsert/delete con `@AuthScope` en vez de `@NoAuthScope`:
 * [MergeSuggestionListener] corre en su propio hilo, sin `Principal`/`SecurityContext`,
