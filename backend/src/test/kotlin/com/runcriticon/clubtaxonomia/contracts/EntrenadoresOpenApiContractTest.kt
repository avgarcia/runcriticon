 ...
 */
class EntrenadoresOpenApiContractTest : IntegrationTestBase() {
    @LocalServerPort
    ...
    fun `listar devuelve al entrenador sembrado con grupos vacios y cumple el contrato`() {
        ...
        assertTrue(fila.get("grupos").isEmpty, "grupos debería salir vacío sin grupos asignados: ${fila.get("grupos")}")
