...
/**
 * `GroupRepository.findGroupsRequiringAnyTagValue` (aviso de impacto al archivar un tag o valor en uso) contra Postgres real: variante con nombre y con el caso
