...
## Stack
- **Kotlin** sobre **Java 25 LTS** (ADR-0001 D12 + ADR-0016). Runtime y toolchain alineados en **GraalVM CE 25** modo JIT (`Dockerfile` + toolchain Gradle + CI `setup-graalvm`); en local `.sdkmanrc` usa Temurin 25.
