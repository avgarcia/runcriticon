...
- **Estado**: Propuesto
- **Fecha**: 2026-05-22 · revisado 2026-05-29 (reorganización Nivel 1: premisas heredadas, NFRs propios, sub-decisiones numeradas D1-D26 con anchors; **corrección de la posición sobre anonimización**: se sustituye "anonimización descartada" por el **patrón de borrado mixto** que el resto de la arquitectura ya asume — coherencia con ADR-0009 D17; incorporación de: categorización explícita de datos en seis grupos, política de retención por categoría, base legal de datos de salud, tratamiento de menores, captura técnica del consentimiento, RAT, DPIA simplificado, DPO no formal con análisis, lista nominal de subencargados, responsable del tratamiento, runbook de respuesta a brechas, anonimización de IPs en logs operativos)
