...
- **Lenguaje ubicuo en castellano** fijado por discovery y consolidado en `docs/glosario.md`. Es el lenguaje del código en este ADR — sin traducción.
...
- **Lenguaje ubicuo**: los términos del discovery (alumno, entrenador, grupo, plan, sesión, reporte, tag, marca, personalización) **son** los nombres en el código. Recogidos en [`docs/glosario.md`](../glosario.md).
